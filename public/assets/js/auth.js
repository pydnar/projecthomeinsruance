      ...
      .then(function() {
        $.ajax("/login/" + email + "/" + password, {
          ...
          if (firebase.auth().currentUser !== null)
            alert("user id: " + firebase.auth().currentUser.email);
         // $("#userprofile").text(firebase.auth().currentUser.email);
localStorage.setItem("EMAIL", firebase.auth().currentUser.email);
// Retrieve
document.getElementById("userprofile").innerHTML = localStorage.getItem("EMAIL");
          userandassets = res;
